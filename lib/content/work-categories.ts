...
export const workCategories: WorkCategory[] = [
    ...
    photos: [
      {
        ...
        alt: "PVS technician on a ladder cleaning an upper window above bright flower boxes at an Ottawa Valley cottage",
        caption: "Upper window · cottage detail",
        width: 1350,
        height: 1800,
      },
      {
        src: "/images/gallery/window-cleaning/downtown-storefront-sip-social.webp",
        alt: "Downtown Pembroke storefront glass cleaned by PVS with ladders staged along the block",
        caption: "Downtown storefronts · Pembroke",
        width: 1200,
        height: 1600,
      },
      {
        src: "/images/gallery/window-cleaning/two-storey-porch-home-clean-windows.webp",
        alt: "Two-storey home with wraparound porch and streak-free windows after a PVS visit",
        caption: "Two-storey · streak-free",
        width: 1350,
        height: 1800,
      },
      {
        src: "/images/gallery/window-cleaning/stone-bungalow-clean-windows.webp",
        alt: "Stone bungalow with sparkling clean windows on a sunny day in Petawawa",
        caption: "Stone bungalow · finished",
        width: 1170,
        height: 1560,
      },
      {
        ...
        caption: "Heritage home · Pembroke",
        width: 1200,
        height: 1600,
      },
      {
    ...
    photos: [
      {
        ...
        alt: "Stand-on mower on a freshly striped backyard lawn beside a garden in Petawawa",
        caption: "Backyard stripes · stand-on mower",
        width: 1200,
        height: 1600,
      },
      {
        src: "/images/gallery/lawn-mowing/stand-on-mower-poolside-lawn.webp",
        alt: "Freshly mowed poolside lawn with a stand-on mower at a large Ottawa Valley property",
        caption: "Poolside cut · full property",
        width: 1200,
        height: 1600,
      },
      {
        src: "/images/gallery/lawn-mowing/fresh-cut-front-lawn-brick-home.webp",
        alt: "Sharp fresh-cut front lawn at a brick home in Pembroke after a PVS visit",
        caption: "Front lawn · weekly visit",
        width: 1200,
        height: 1600,
      },
      {
    ...
    photos: [
      {
        ...
        alt: "PVS tractor snow-blowing a residential driveway at sunrise after an overnight storm in Petawawa",
        caption: "Sunrise clearing · storm done",
        width: 1350,
        height: 1800,
      },
      {
        src: "/images/gallery/snow-removal/tractor-cleared-driveway-bluebird-day.webp",
        alt: "John Deere tractor on a freshly cleared driveway under a bright winter sky in Petawawa",
        caption: "Driveway open · bluebird day",
        width: 1350,
        height: 1800,
      },
      {
        src: "/images/gallery/snow-removal/pvs-truck-commercial-lot-night.webp",
        alt: "PVS truck clearing a commercial gas station lot during an overnight snowfall in Pembroke",
        caption: "Commercial lots · overnight",
        width: 1200,
        height: 1600,
      },
      {
        src: "/images/gallery/snow-removal/tractor-cab-route-tablet.webp",
        alt: "View from inside the tractor cab with the GPS route tablet during a storm run",
        caption: "In the cab · routed by GPS",
        width: 1350,
        height: 1800,
      },
      {
  ...
  {
    slug: "landscaping",
    name: "Landscaping & Interlock Projects",
    shortName: "Landscaping",
    division: "lawnpros",
    description:
      "Interlock walkways, paver patios, garden bed refreshes, and full outdoor rebuilds. From tear-out to the final compacted stone, all by one local crew.",
    icon: Leaf,
    photos: [
      {
        src: "/images/gallery/landscaping/interlock-walkway-before-old-pavers.webp",
        alt: "Aging patio-slab front walkway with timber edging before an interlock rebuild in Petawawa",
        caption: "Front walkway · before",
        width: 1200,
        height: 1600,
      },
      {
        src: "/images/gallery/landscaping/interlock-walkway-excavation-sand-base.webp",
        alt: "Front walkway fully excavated to a sand base ahead of new interlock pavers in Petawawa",
        caption: "Tear-out & excavation",
        width: 1200,
        height: 1600,
      },
      {
        src: "/images/gallery/landscaping/interlock-walkway-plate-compactor-base.webp",
        alt: "PVS crew member running a plate compactor over the walkway base with string lines set",
        caption: "Base compaction · lines set",
        width: 1013,
        height: 1800,
      },
      {
        src: "/images/gallery/landscaping/interlock-walkway-compacting-crew.webp",
        alt: "Crew member compacting the gravel base beside the stone front steps before laying pavers",
        caption: "Compacting the base",
        width: 1200,
        height: 1600,
      },
      {
        src: "/images/gallery/landscaping/interlock-walkway-laying-pavers.webp",
        alt: "PVS crew member setting interlock pavers by hand with a rubber mallet on a screeded bed",
        caption: "Setting pavers by hand",
        width: 900,
        height: 1600,
      },
      {
        src: "/images/gallery/landscaping/interlock-walkway-polymeric-sand-finish.webp",
        alt: "Finished interlock walkway being watered to set the polymeric sand joints",
        caption: "Locking in the joints",
        width: 1200,
        height: 1600,
      },
      {
        src: "/images/gallery/landscaping/interlock-walkway-after-charcoal-border.webp",
        alt: "Completed interlock walkway with charcoal paver border leading to the front steps in Petawawa",
        caption: "After · charcoal border",
        width: 1200,
        height: 1600,
      },
      {
        src: "/images/gallery/landscaping/interlock-walkway-after-wide.webp",
        alt: "Wide view of the finished interlock front walkway and stone steps at a Petawawa bungalow",
        caption: "After · walkway complete",
        width: 1200,
        height: 1600,
      },
      {
        src: "/images/gallery/landscaping/pool-deck-before-overgrown.webp",
        alt: "Overgrown vines and shifting patio slabs crowding a backyard pool before a PVS landscaping rebuild",
        caption: "Poolside · before",
        width: 1200,
        height: 1600,
      },
      {
        src: "/images/gallery/landscaping/pool-deck-lifting-old-slabs.webp",
        alt: "Crew member prying up old patio slabs beside the pool during demolition",
        caption: "Lifting the old slabs",
        width: 1013,
        height: 1800,
      },
      {
        src: "/images/gallery/landscaping/pool-deck-hauling-broken-slabs.webp",
        alt: "PVS crew member loading broken patio slabs into a wheelbarrow beside the pool",
        caption: "Demo & haul-away",
        width: 900,
        height: 1600,
      },
      {
        src: "/images/gallery/landscaping/pool-deck-after-fresh-grade.webp",
        alt: "Fresh topsoil graded smooth around the backyard pool after the old patio tear-out",
        caption: "Regraded · ready for seed",
        width: 1200,
        height: 1600,
      },
      {
        ...
        caption: "Poolside · after",
        width: 1200,
        height: 1600,
      },
      {
        src: "/images/gallery/landscaping/pool-deck-after-evening-wide.webp",
        alt: "Evening view of the finished backyard with fresh grading around the pool and hot tub",
        caption: "After · evening light",
        width: 1350,
        height: 1800,
      },
      {
