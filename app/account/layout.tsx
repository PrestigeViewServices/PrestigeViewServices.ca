      ...
      <section className="container-max flex min-h-[70vh] flex-col items-center justify-center py-12">
        <div className="mb-8 text-center">
            ...
            {offer.enabled ? (
              <>
                ...
                <span className="text-gradient">
                  Save {offer.label} on your next service.
                </span>
              </>
            ) : (
              <>
          ...
          <p className="mx-auto mt-3 max-w-md text-sm text-muted-foreground">
            {offer.enabled ? (
              <>
                Members take {offer.label} off their next service, earn points
                on every paid visit, and earn{" "}
                {formatCents(settings.pointsReferral * settings.centsPerPoint)}{" "}
                every time they refer someone. Free to join.
              </>
            ) : (
              <>
        ...
        <AccountAuth discountLabel={offer.enabled ? offer.label : null} />
      </section>
    );
  }
